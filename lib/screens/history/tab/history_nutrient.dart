    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              if (_isNotZeroList(data!.caloriesList) && data!.caloriesList.isNotEmpty)
                HistoryCard(
                    name: 'แคลอรี',
                    ...
                    isBody: false),
              if (_isNotZeroList(data!.proteinList) && data!.proteinList.isNotEmpty)
                HistoryCard(
                    name: 'โปรตีน',
              ...
              if (_isNotZeroList(data!.waterList) && data!.waterList.isNotEmpty)
                HistoryCard(
                    ...
                    stopDate: data!.foodStartDate,
                    isBody: false),
              if (_isNotZeroList(exerciseList) /*&& data!.exerciseList.isNotEmpty*/)
                HistoryCard(
                    name: 'เผาผลาญพลังงาน',
